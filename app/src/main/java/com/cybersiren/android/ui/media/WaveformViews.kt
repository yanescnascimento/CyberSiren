...
import com.cybersiren.android.features.voice.VoiceWaveformCache
import com.cybersiren.android.features.voice.resampleWave
...
fun WaveformPreview(
    ...
    WaveformCanvas(
        ...
        fillColor = when {
            sendProgress != null -> Color(0xFF1E88E5)
