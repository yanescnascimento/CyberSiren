package com.cybersiren.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.cybersiren.android.model.BitchatFilePacket
    ): String {
    ...
    fun messageTypeForMime(mime: String): com.cybersiren.android.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.cybersiren.android.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.cybersiren.android.model.BitchatMessageType.Audio
            else -> com.cybersiren.android.model.BitchatMessageType.File
        }
    }
